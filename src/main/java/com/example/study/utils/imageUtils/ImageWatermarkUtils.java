...
public class ImageWatermarkUtils {
    ...
    public static void main(String[] args) {
        ...
        String srcImgPath = path1;
        String logoText = "复印无效";
        String iconPath = "d:/2.jpg";

        String targerTextPath = path2;
...
//        System.out.println("给图片添加水印图片结束...");
    ...
    public static void setImageMarkOptions(float alpha, int positionWidth,
        ...
        if (alpha != 0.0f)
            ImageWatermarkUtils.alpha = alpha;
        if (positionWidth != 0)
            ImageWatermarkUtils.positionWidth = positionWidth;
        if (positionHeight != 0)
            ImageWatermarkUtils.positionHeight = positionHeight;
        if (font != null)
            ImageWatermarkUtils.font = font;
        if (color != null)
            ImageWatermarkUtils.color = color;
    }
